...
# Apply drill-down to an arbitrarily chosen product:
# prod.ts <- dat %>% 
#   select.product(
#     # selected.Category = "LAUNDRY DETERGENTS V2 CATEGORY",
#     selected.Company = "PROCTER&GAMBLE",
#     selected.Brand = "ARIEL",
#     selected.Form = "GEL",
#     selected.Concentration = "SUPER CONCENTRATE",
#     selected.BasicSize = "666ML",
#     selected.SecondBenefit = "BASE",
#     selected.NumberOfJobs = "18",
#     selected.Item = "+AEGWF FEBRZ LNDTG GEL 1CT 666ML"
#   ) %>% 
#   filter(complete.cases(.)) # Remove cases with missing values
# prod <- prod.ts %>% select(-one_of("Date")) # This isn't a feature; remove it
